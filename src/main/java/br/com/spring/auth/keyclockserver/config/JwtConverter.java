...
public class JwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private Collection<? extends GrantedAuthority> extractRoles(Jwt jwt) {
        ...
        // Extract roles from resource_access.keyclockserverexample
        Map<String, Object> resourceAccess = jwt.getClaim("resource_access");
        if (resourceAccess != null && resourceAccess.containsKey("keyclockserverexample")) {
            Map<String, Object> demoAccess = (Map<String, Object>) resourceAccess.get("keyclockserverexample");
